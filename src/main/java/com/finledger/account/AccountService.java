...
public class AccountService {
    ...
    public Long createAccount(String custNm, BigDecimal balance) {
        ...
        String accountNumber = accountNumberGenerator.generate(saved.getAccountId());
    ...
    public void transfer(Long fromId, Long toId, BigDecimal amount) {
        ...
        Account fromAccount = firstAccount.getAccountId().equals(fromId) ? firstAccount : secondAccount;
        Account toAccount   = firstAccount.getAccountId().equals(toId) ? firstAccount : secondAccount;
